...
public class Sc004_KodiBehavioralParity : ScannerIntegrationTestBase
{
    ...
    /// </summary>
    private static readonly (string Path, string FileName, bool IsDirectory, string? Extension, string KodiOutcome)[] ParityFixture =
    [
        ...
        ("/nas/Movies/Interstellar (2014)/Interstellar (2014).mkv", "Interstellar (2014).mkv", false, "mkv", "Movie"),
        ("/nas/Movies/Pulp Fiction (1994)/Pulp Fiction (1994).mkv", "Pulp Fiction (1994).mkv", false, "mkv", "Movie"),
        ("/nas/Movies/The Dark Knight (2008)/The Dark Knight (2008).mkv", "The Dark Knight (2008).mkv", false, "mkv", "Movie"),

        // Flat-folder movies — Kodi classifies as Movie (from filename)
        ("/nas/Movies/Inception.2010.1080p.BluRay.x264-GROUP.mkv", "Inception.2010.1080p.BluRay.x264-GROUP.mkv", false, "mkv", "Movie"),
        ("/nas/Movies/Dune.2021.BluRay.mkv", "Dune.2021.BluRay.mkv", false, "mkv", "Movie"),

        // Stacked movies — Kodi groups as a single Movie
        ("/nas/Movies/Kill Bill Vol 1 (2003)/Kill.Bill.Vol.1.2003.cd1.mkv", "Kill.Bill.Vol.1.2003.cd1.mkv", false, "mkv", "Movie"),
        ("/nas/Movies/Kill Bill Vol 1 (2003)/Kill.Bill.Vol.1.2003.cd2.mkv", "Kill.Bill.Vol.1.2003.cd2.mkv", false, "mkv", "Movie"),

        // TV episodes — Kodi classifies as Episode
        ("/nas/TV Shows/Breaking Bad/Season 01/Breaking.Bad.S01E01.mkv", "Breaking.Bad.S01E01.mkv", false, "mkv", "Episode"),
        ("/nas/TV Shows/Breaking Bad/Season 01/Breaking.Bad.S01E02.mkv", "Breaking.Bad.S01E02.mkv", false, "mkv", "Episode"),
        ("/nas/TV Shows/Breaking Bad/Season 02/Breaking.Bad.S02E01.mkv", "Breaking.Bad.S02E01.mkv", false, "mkv", "Episode"),

        // Multi-episode file — Kodi classifies as Episode
        ("/nas/TV Shows/The Office US/Season 01/The.Office.US.S01E01-E02.mkv", "The.Office.US.S01E01-E02.mkv", false, "mkv", "Episode"),
        ...
        ("/nas/TV Shows/Doctor Who/Specials/Doctor.Who.S00E01.Special.mkv", "Doctor.Who.S00E01.Special.mkv", false, "mkv", "Episode"),

        // Date-based episode — Kodi classifies as Episode
        ("/nas/TV Shows/The Daily Show/Season 2024/The.Daily.Show.2024.03.18.mkv", "The.Daily.Show.2024.03.18.mkv", false, "mkv", "Episode"),

        // Exclusions — Kodi excludes these
        ("/nas/Movies/The Matrix (1999)/The.Matrix.1999-sample.mkv", "The.Matrix.1999-sample.mkv", false, "mkv", "Excluded"),
    ...
    public async Task Sc004_KodiBehavioralParity_AtLeast99Percent()
    {
        ...
        parityRate.Should().BeGreaterThanOrEqualTo(0.99,
            because: $"SC-004 requires ≥ 99% Kodi behavioral parity. " +
